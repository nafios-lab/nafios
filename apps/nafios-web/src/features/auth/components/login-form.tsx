...
export function LoginForm({ redirectTo = "/" }: LoginFormProps) {
  ...
  const { signIn, isLoading, error } = useSignIn({
    // signInWithPassword persisted the session client-side and the hook
    // invalidated ['session']; navigating re-runs the target's beforeLoad, which
    // now sees the session and lets the user through.
