...
function SidebarProvider({
  ...
  // Internal state — used when the component is not controlled via `open`.
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: upstream shadcn pattern for SSR-readable sidebar state
