...
│       └── repositories/
│           └── ledger-repository.ts      # createLedgerRepository / LedgerRepository  ← this ticket
└── tests/
    └── integration/
        └── ledger-repository.test.ts     # the §6 matrix (two seeded users, local Supabase)  ← this ticket (harness)
```
